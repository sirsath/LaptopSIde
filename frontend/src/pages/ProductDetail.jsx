                        ...
                        <Grid container spacing={2}>
                            <Grid xs={2}>
                                <Stack direction="column" spacing={2}>
                                    {
                                        singleProduct?.image.map(item => <img src={`${URL}/${item}`} onMouseOver={e => setSelectedImg(item)} />)
                                    }
                                </Stack>
                            </Grid>
                            <Grid xs={10}>
                                {
                                    <img src={`${URL}/${selectedImg ? selectedImg : singleProduct.image[0]}`} style={{ maxWidth: "100%" }} />
                                }
